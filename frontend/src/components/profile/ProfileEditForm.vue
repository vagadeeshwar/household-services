<template>
  <div class="card shadow-sm mb-4">
    <div class="card-header bg-white d-flex justify-content-between align-items-center">
      ...
      <button class="btn btn-sm btn-outline-primary" @click="toggleEditMode" v-if="!editMode">
    ...
    <div class="card-body p-4">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <div v-if="v$.full_name.$error" class="invalid-feedback">
              ...
              <span v-else-if="v$.full_name.minLength.$invalid">Full name must be at least 3
                characters</span>
            </div>
          </div>
      ...
      <div v-else class="text-center py-4">
        <p class="text-muted">Click the edit button to update your profile information.</p>
      </div>
    </div>
...
export default {
  ...
  setup({ emit }) {
    ...
    const originalFormData = reactive({
      ...
      pin_code: userData.value.pin_code || '',
    ...
    const rules = computed(() => {
      ...
      if (isUserProfessional.value && userData.value.description !== undefined) {
        baseRules.description = { required, minLength: minLength(10), maxLength: maxLength(100) };
      }
    ...
    // Computed property to determine if user is a professional

...
export default {
  ...
  setup(props, { emit }) {
    ...
    const formattedLastLogin = computed(() =>
      userData.value?.last_login ? moment(userData.value.last_login).format('MMM DD, YYYY hh:mm A') : 'N/A'
    );
    const formattedCreatedAt = computed(() =>
      userData.value?.created_at ? moment(userData.value.created_at).format('MMM DD, YYYY hh:mm A') : 'N/A'
    );

        ...
        <div class="row align-items-center">
          <div class="col-md-6">
            <ul class="nav nav-pills">
              <li class="nav-item">
                <a class="nav-link" :class="{ active: activeStatus === 'all' }"
                  @click.prevent="filterByStatus('all')" href="#">
                  All Requests
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" :class="{ active: activeStatus === 'created' }"
                  @click.prevent="filterByStatus('created')" href="#">
                  <i class="bi bi-hourglass-split me-1"></i>Pending
                  <span v-if="requestCountByStatus.created"
              ...
              <li class="nav-item">
                <a class="nav-link" :class="{ active: activeStatus === 'assigned' }"
                  @click.prevent="filterByStatus('assigned')" href="#">
                  <i class="bi bi-arrow-repeat me-1"></i>In Progress
                  <span v-if="requestCountByStatus.assigned"
                    class="badge bg-light text-primary ms-1">
              ...
              <li class="nav-item">
                <a class="nav-link" :class="{ active: activeStatus === 'completed' }"
                  @click.prevent="filterByStatus('completed')" href="#">
            ...
            <div class="col-md-4">
              <div class="d-flex flex-column">
                ...
                <div>
                  ...
                  <div class="text-truncate-2">{{ request.description || 'No description provided'
                    }}</div>
                </div>
              </div>
            </div>
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <div class="small text-muted">Duration: {{
                    formatDuration(request.service.estimated_time) }}</div>
                </div>
                <div class="d-flex">
                  ...
                  <button v-if="request.status === 'created'" class="btn btn-sm btn-outline-danger"
                  ...
                  <button v-if="request.status === 'completed' && !request.review"
                    class="btn btn-sm btn-outline-warning" @click="showReviewModal(request)">
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content" v-if="selectedRequest">
                    ...
                    <div v-if="selectedRequest.review" class="mt-4 border-top pt-3">
                      ...
                      <div class="d-flex mb-2">
                        <div v-for="i in 5" :key="i" class="me-1">
                          <i class="bi"
                            :class="i <= selectedRequest.review.rating ? 'bi-star-fill text-warning' : 'bi-star'"></i>
                        </div>
                        <span class="ms-2">{{ selectedRequest.review.rating }}/5</span>
                      </div>
                      <p v-if="selectedRequest.review.comment">{{ selectedRequest.review.comment }}
                      </p>
                ...
                <div class="card h-100">
                  ...
                  <div class="card-body">
                    <div v-if="selectedRequest.professional">
                      ...
                      <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center">
                          ...
                          <span>{{ selectedRequest.professional.average_rating.toFixed(1)
                            }}/5.0</span>
                        </div>
                      </div>
                    </div>
                    <div v-else class="text-center py-4">
                      ...
                      <p class="small text-muted">A professional will be assigned to your request
                        soon.</p>
                    </div>
                  </div>
                </div>
          ...
          <div class="modal-footer">
            ...
            <button v-if="selectedRequest.status === 'created'" type="button" class="btn btn-danger"
              @click="confirmCancelRequestFromModal" :disabled="isProcessing">
              <span v-if="isProcessing" class="spinner-border spinner-border-sm me-1"></span>
              Cancel Request
            </button>
            <button v-if="selectedRequest.status === 'completed' && !selectedRequest.review"
              type="button" class="btn btn-warning" @click="showReviewModalFromDetail">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <ul class="list-unstyled">
                ...
                <li><strong>Scheduled Time:</strong> {{
                  formatDateLong(selectedRequest.preferred_time) }}</li>
            ...
            <form @submit.prevent="submitReview">
              ...
              <div class="mb-4">
                ...
                <div class="rating-stars">
                  <div class="d-flex">
                    <span v-for="star in 5" :key="star" class="fs-2 cursor-pointer star-icon"
              ...
              <div class="mb-3">
                ...
                <textarea id="reviewComment" class="form-control" v-model="reviewForm.comment"
...
export default {
  ...
  setup() {
    ...
    const filteredRequests = computed(() => {
      ...
      if (searchQuery.value.trim()) {
        ...
        result = result.filter(request =>
          ...
          (request.professional?.user?.full_name?.toLowerCase().includes(query) || false)
        );
      }
    ...
    const endIndex = computed(() => Math.min(startIndex.value + itemsPerPage.value, totalRequests.value));
